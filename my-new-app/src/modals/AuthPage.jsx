...
const AuthPage = ({ mode, onBack }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-zinc-950/60 backdrop-blur-md p-4 sm:p-6 overflow-y-auto">
      <div className="w-full max-w-[420px] rounded-[2rem] bg-white/95 backdrop-blur-2xl p-8 sm:p-10 shadow-[0_20px_50px_-12px_rgba(0,0,0,0.5)] border border-white/50 relative my-auto animate-in fade-in zoom-in-95 duration-300">
        <button onClick={onBack} className="absolute right-6 top-6 text-zinc-400 hover:text-zinc-900 bg-zinc-100 hover:bg-zinc-200 p-2.5 rounded-full transition-all">
